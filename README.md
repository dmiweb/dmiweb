...
Приложение Фильмотека — это веб-приложение, демонстрирующее навыки работы с React, Redux Toolkit, и внешними API. Приложение позволяет искать фильмы по названию, добавлять фильмы в избранное, просматривать подробную информацию о фильме и просматривать список избранных фильмов.
